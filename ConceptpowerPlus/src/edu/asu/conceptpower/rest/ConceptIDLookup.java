...
@Path("/Concept")
public class ConceptIDLookup extends AbstractLookup {
	...
	public String getConceptById(@QueryParam("id") String id, @Context HttpServletRequest request, @Context HttpServletResponse response) {
