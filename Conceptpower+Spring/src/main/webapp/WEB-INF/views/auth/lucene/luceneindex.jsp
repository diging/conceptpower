...
<body>
            ...
            <div class="containerBlock">
                <form:form
                    ...
                    <table style="vertical-align: top">
                        <tr>
                            <td>
                                <button type="button" class="btn btn-primary" id="waitMe_ex">Index WordNet Wrappers</button>
                            </td>

                            <td>
                                <button type="button" class="btn btn-primary" id="waitMe_Delete">Delete Indexes</button>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <br />
                    <br />
                    <table id="luceneTable" style="vertical-align: top"
                        border="1" width="400">
                        <tr>
                            <th align="center">Total Indexed
                                Concepts</th>
    ...
    <script src="${pageContext.servletContext.contextPath}/resources/js/waitMe.js"></script>

    <script>
    $(function() {
    
    	var current_effect = $('#waitMe_ex_effect').val();
    	$('#waitMe_Delete').click(function() {
    	...
    	$('#waitMe_ex').click(function index() {
			run_waitMe(current_effect);
			$.ajax({
