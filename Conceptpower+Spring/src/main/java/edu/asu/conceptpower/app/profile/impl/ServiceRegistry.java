 ...
 * service which implements IService interface
 * 
...
public class ServiceRegistry implements IServiceRegistry {
	...
	/**
	 * this method takes serviceId as argument and returns the service object
	 * associated with it
	 * 
	 * @param serviceId
	 *            id of the service of which object is required
	...
	public Map<String, String> getServiceNameIdMap() {
		...
		while (iterator.hasNext()) {
			...
			serviceIdNameMap.put(serviceObj.getServiceId(),
					serviceObj.getName());
		}
		return serviceIdNameMap;
	}
