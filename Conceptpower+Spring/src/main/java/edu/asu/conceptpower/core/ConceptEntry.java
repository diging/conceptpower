...
public class ConceptEntry implements Serializable {
    ...
    @Id
    @LuceneField(lucenefieldName = LuceneFieldNames.ID, isTokenized = false, isCommaSeperated = false)
    private String id;

    @SearchField(fieldName = SearchFieldNames.WORDNETID)
    @LuceneField(lucenefieldName = LuceneFieldNames.WORDNETID, isTokenized = false, isCommaSeperated = true)
    private String wordnetId;

    @SearchField(fieldName = SearchFieldNames.WORD)
    @LuceneField(lucenefieldName = LuceneFieldNames.WORD, isTokenized = true, isCommaSeperated = false)
    private String word;

    @SearchField(fieldName = SearchFieldNames.DESCRIPTION)
    @LuceneField(lucenefieldName = LuceneFieldNames.DESCRIPTION, isTokenized = true, isCommaSeperated = false)
    private String description;

    @SearchField(fieldName = SearchFieldNames.POS)
    @LuceneField(lucenefieldName = LuceneFieldNames.POS, isTokenized = true, isCommaSeperated = false)
    private String pos;

    @SearchField(fieldName = SearchFieldNames.CONCEPT_LIST)
    @LuceneField(lucenefieldName = LuceneFieldNames.CONCEPT_LIST, isTokenized = false, isCommaSeperated = false)
    private String conceptList;

    @SearchField(fieldName = SearchFieldNames.TYPE_ID)
    @LuceneField(lucenefieldName = LuceneFieldNames.TYPE_ID, isTokenized = false, isCommaSeperated = false)
    private String typeId;

    @SearchField(fieldName = SearchFieldNames.EQUALS_TO)
    @LuceneField(lucenefieldName = LuceneFieldNames.EQUALS_TO, isTokenized = false, isCommaSeperated = true)
    private String equalTo;

    @SearchField(fieldName = SearchFieldNames.SIMILAR_TO)
    @LuceneField(lucenefieldName = LuceneFieldNames.SIMILAR_TO, isTokenized = false, isCommaSeperated = true)
    private String similarTo;

    @SearchField(fieldName=SearchFieldNames.SYNONYM_ID)
    @LuceneField(lucenefieldName = LuceneFieldNames.SYNONYMID, isTokenized = false, isCommaSeperated = true)
    ...
    @LuceneField(lucenefieldName = LuceneFieldNames.CREATOR, isTokenized = false, isCommaSeperated = false)
    private String creatorId;

    @SearchField(fieldName = SearchFieldNames.MODIFIED)
    @LuceneField(lucenefieldName = LuceneFieldNames.MODIFIED, isTokenized = false, isCommaSeperated = false)
